...
def CSConfig2():
    ...
    print('vMgmtS01 vm created ...')
#    subprocess.call(['virsh start vMgmtS01'], shell=True)
#    subprocess.call(["wget https://big3v.com/CSIAAS/sshpass-1.05.tar -P ./resources"], shell=True)
#    subprocess.call(['tar xvf ./resources/sshpass-1.05.tar'], shell=True)
#    subprocess.call(['./sshpass-1.05/configure'], shell=True)
...
#    print('cloudstack-setup-databases Start')
#    subprocess.call(['sshpass -p "Fa26Lio5" ssh -o StrictHostKeyChecking=no root@192.168.122.10 "cloudstack-setup-databases cloud:Fa26Lio5@localhost --deploy-as=root:Fa26Lio5 -i 192.168.122.10"'], shell=True)
#    print('cloudstack-setup-databases Done')
#    subprocess.call(['sshpass -p "Fa26Lio5" ssh -o StrictHostKeyChecking=no root@192.168.122.10 "cloudstack-setup-management"'], shell=True)
#    print('Install Template Start')
#    subprocess.call(['sshpass -p "Fa26Lio5" ssh -o StrictHostKeyChecking=no root@192.168.122.10 "/usr/share/cloudstack-common/scripts/storage/secondary/cloud-install-sys-tmplt -m /mnt/secondary -u https://big3v.com/CSIAAS/systemvm64template-4.5-xen.vhd.bz2 -h xenserver -F"  > /dev/null 2>&1 & '], shell=True)
#    print('Install Template Done')
#    subprocess.call(['sshpass -p "Fa26Lio5" ssh -o StrictHostKeyChecking=no root@192.168.122.10 "service cloudstack-management start"'], shell=True)
#    subprocess.call(['sshpass -p "Fa26Lio5" ssh -o StrictHostKeyChecking=no root@192.168.122.10 "chkconfig cloudstack-management on"'], shell=True)
    subprocess.call(['virsh start vXS01'], shell=True)
    subprocess.call(['virsh start vMgmtS01'], shell=True)
