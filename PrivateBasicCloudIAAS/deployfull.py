...
#     subprocess.call(['wget ' + stuffurl + 'vMgmtS01.qcow2 -P /var/lib/libvirt/images'], shell=True)
...
#    subprocess.call(['wget ' + stuffurl + 'systemvm64template-4.5-xen.vhd.bz2 -P ./resources'], shell=True)
...
def PreReboot():
    file = open("/etc/profile.d/CSConfigFull.sh", "w")
    file.write('#!/bin/sh\n')
    ...
    file.write('python CSConfigFull.py\n')
    file.write('rm /etc/profile.d/CSConfigFull.sh')
    file.close()
